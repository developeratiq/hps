...
function AboutUs() {
    return (
        <section className='mt-[8vh]  flex gap-6 w-[90vw] flex-initial ml-[10vw]'>
            ...
            <div className='flex-2 sec2 '>
                ...
                <div className='about-usbottom'>
                    <div className='bg-[#28a745] text-xl'>
                        <h1>123</h1>
                        <h1>Available Subject</h1>
                    </div>
                    <div className='bg-[#2878eb] text-xl'>
                        <h1>123</h1>
                        <h1>Online Courses</h1>
                    </div>
                    <div className='bg-[#f14d5d] text-xl'>
                        <h1>123</h1>
                        <h1>Skilled Instructors</h1>
                    </div>
                    <div className='bg-[#ffc107] text-xl'>
                        <h1>123</h1>
